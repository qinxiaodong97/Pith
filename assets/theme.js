...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      $productViews: $('.product-image-view', this.$container),
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    productImageGallery: function() {
      ...
      this.selectors.$productViews.bind('click', function() {
        var imageId = $(this).attr('data-image-id');
      ...
      var selectCallback = function(variant, selector) {
        self.productPage({
          ...
          translations: {
            ...
            coming_soon: theme.productStrings.comingSoon
          }
        });
      };
    ...
    productPage: function(options) {
      ...
      if (variant) {
        ...
        if (variant.available) {
          ...
          if (self.productSingleObject.tags.includes('comingsoon')) {
            this.selectors.$addToCartText.html(theme.strings.comingSoon);
          } else {
  ...
  function Sidebar() {
    ...
    $(selectors.mobileMenuTrigger).on(
      ...
      function(evt) {
        ...
        if (sidebarTop) {
          if (sidebarTop.classList.contains('active')) {
            sidebarTop.classList.remove('active');
          } else {
            sidebarTop.classList.add('active');
          }
        }
...
theme.ProductRecommendations = (function() {
  function ProductRecommendations(container) {
    ...
    const cartEl = document.querySelector('#cart-data');
    var cart = null;
    console.log('data = ', cart);
    if (cartEl) {
      cart = JSON.parse(cartEl.innerHTML);
...
$(document).ready(function() {
  ...
  var lastScrollTop = 0;
  const bottomContent = document.querySelector('.bottom-link');
  if (bottomContent) {
    window.addEventListener('scroll', (e) => {
      e.preventDefault();
      var st = window.pageYOffset || document.documentElement.scrollTop; // Credits: "https://github.com/qeremy/so/blob/master/so.dom.js#L426"
      if (st > lastScrollTop) {
        //bottomContent.classList.add('active');
      } else if (st < lastScrollTop) {
        bottomContent.classList.remove('active');
